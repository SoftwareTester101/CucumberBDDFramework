...
public class ContactsStepDefinition {
    ...
    public void user_fills_in_username_and_password_in_the_login_page(DataTable credentials) {
        for (Map<String, String> data : credentials.asMaps(String.class, String.class)) {
            this.driver.findElement(By.id("user_login")).sendKeys(data.get("username"));
            this.driver.findElement(By.id("user_pass")).sendKeys(data.get("password"));
        }
    }
    ...
    public void user_fills_contact_details_and(DataTable credentials) throws InterruptedException {
        for (Map<String, String> data : credentials.asMaps(String.class, String.class)) {
            this.driver.findElement(By.id("user_login")).sendKeys(data.get("username"));
            this.driver.findElement(By.id("email")).sendKeys(data.get("email"));
            this.driver.findElement(By.id("first_name")).sendKeys(data.get("first_name"));
